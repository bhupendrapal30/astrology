...
const UserSlice = createSlice({
  ...
  initialState: {
    ...
    productData: SessionHelper.GetUserDetails() || undefined,
  },
...
export const { SetUserDetails,SetUserData,ResetUserData,SetUserList,SetTotalUser,RemoveUserDetails,SetProduct } = UserSlice.actions;
